          ...
          <form action="{{ route('conta.store') }}" method="POST">
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <input name="numero_conta" type="text" class="form-control" placeholder="Digite o número de conta" value="{{ old('numero_conta') }}" required autofocus />
                  @error('numero_conta')
                  ...
                  <div class="col-md-6 pr-1">
                    <div class="form-group">
                        <label >Avalista</label>
                          ...
                          <option value="{{ $avalista->id }}">{{ $avalista->nome }}</option>
                          @endforeach
                        </select>
                        @error('avalista_id')
                        <small style="color: red;">{{ $message }}</small>
            ...
            <div class="row">
              <div class="update ml-auto mr-auto">
                <button type="submit" class="btn btn-primary btn-round">Criar Conta</button>
              </div>
            </div>
          </form>
        </div>
